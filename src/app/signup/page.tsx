            ...
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 bg-white shadow-xl rounded-xl overflow-hidden">
                <div className="p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-slate-600">Fullname</label>
                            <input
                                type="text"
                                value={name}
                        ...
                        <button type="submit" className="w-full bg-rose-500 text-white font-semibold py-2 rounded-lg hover:bg-rose-600">Sign up</button>
